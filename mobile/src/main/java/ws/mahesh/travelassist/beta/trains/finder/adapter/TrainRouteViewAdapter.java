 ...
 */
public class TrainRouteViewAdapter extends RecyclerView.Adapter<TrainRouteViewAdapter.TrainViewHolder> {
    List<TrainFinderObject> data = Collections.emptyList();
    private LayoutInflater inflater;
    private Context context;

    public TrainRouteViewAdapter(Context context, List<TrainFinderObject> data) {
    ...
    public TrainViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.item_list_train, parent, false);
    ...
    public void onBindViewHolder(TrainViewHolder holder, int position) {
        ...
        holder.stop1.setText(current.getLine());
