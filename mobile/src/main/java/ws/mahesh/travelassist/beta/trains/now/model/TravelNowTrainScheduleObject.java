package ws.mahesh.travelassist.beta.trains.now.model;

/**
 * Created by mahesh on 28/03/15.
 */
public class TravelNowTrainScheduleObject {
    public int id;
    public int cars;
    public int src_time;
    ...
    public TravelNowTrainScheduleObject(int id, int cars, int src_time, int dest_time, int src_station_id, int dest_station_id, int start_id, int end_id, int sunday_only, int holiday_only, int non_sunday, String direction, String speed, String spl_info, int line) {
        this.id = id;
        this.cars = cars;
    ...
    public String toString() {
        return "TravelNowTrainScheduleObject{" +
                "line=" + line +
                ", spl_info='" + spl_info + '\'' +
                ", speed='" + speed + '\'' +
                ", direction='" + direction + '\'' +
