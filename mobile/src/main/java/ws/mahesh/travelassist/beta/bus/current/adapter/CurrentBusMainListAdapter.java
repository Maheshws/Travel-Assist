...
import ws.mahesh.travelassist.beta.bus.current.CurrentBusListActivity;

/**
 * Created by mahesh on 16/03/15.
 */
public class CurrentBusMainListAdapter extends RecyclerView.Adapter<CurrentBusMainListAdapter.Bus1ViewHolder> implements Filterable {
    List<BusWiseObject> data = Collections.emptyList();
    private LayoutInflater inflater;
    private Context context;
    private List<BusWiseObject> orig;

    public CurrentBusMainListAdapter(Context context, List<BusWiseObject> data) {
    ...
    class Bus1ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            Intent i = new Intent(context, CurrentBusListActivity.class);
