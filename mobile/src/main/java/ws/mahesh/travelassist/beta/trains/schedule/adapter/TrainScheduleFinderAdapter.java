package ws.mahesh.travelassist.beta.trains.schedule.adapter;
 ...
 */
public class TrainScheduleFinderAdapter extends RecyclerView.Adapter<TrainScheduleFinderAdapter.TrainViewHolder> {
    List<TrainScheduleObject> data = Collections.emptyList();
    private LayoutInflater inflater;
    private Context context;
    private int LineID;


    public TrainScheduleFinderAdapter(Context context, List<TrainScheduleObject> data, int LineID) {
    ...
    public TrainViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.item_trains_schedule, parent, false);
    ...
    public void onBindViewHolder(TrainViewHolder holder, int position) {
        TrainScheduleObject current = data.get(position);
    ...
    class TrainViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        TextView src_time, speed, cars, dest_time, eta, start_end, spl_info;
