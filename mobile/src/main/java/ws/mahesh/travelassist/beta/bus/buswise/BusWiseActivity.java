...
import ws.mahesh.travelassist.beta.bus.buswise.adapter.BusWiseListAdapter;
...
public class BusWiseActivity extends ActionBarActivity {

    private ArrayList<BusWiseObject> list = new ArrayList<>();
    private BusWiseListAdapter adapter;
    private RecyclerView recyclerView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bus_wise);
        ...
        setUp();
        adapter = new BusWiseListAdapter(this, list);
